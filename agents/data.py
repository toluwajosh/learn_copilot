...
def load_documents(
    ...
    # with Pool(processes=os.cpu_count()) as pool: # does not work on windows
    #     results = []
    #     with tqdm(
    #         total=len(filtered_files), desc="Loading new documents", ncols=80
    #     ) as pbar:
...
def injest_data(
    ...
    print(
        f"Ingestion complete! You can now run privateGPT.py to query your documents"
    )
